...
- 📈 **주식 기술적 분석 (`yfinance` 활용):** 삼성전자, 네이버, 엔비디아 등 30여 개 종목의 실시간 OHLCV 데이터로 RSI·MACD·볼린저밴드를 정밀 계산하여 LLM이 해석
...
- **주식 기술적 분석** (삼성전자, 카카오, 네이버, 엔비디아 등 30여 개 지원):
  > "`삼성전자 기술적 분석해줘`", "`삼성전자 RSI 알려줘`", "`삼성전자 예측해줘`" 등으로 질문
  - RSI(14) · MACD(12,26,9) · 볼린저밴드(20, 2σ) · MA5/20/60 · 거래량을 실제 데이터로 수치 계산
  - 산출된 수치를 기반으로 LLM이 한국어로 종합 해석 구성
